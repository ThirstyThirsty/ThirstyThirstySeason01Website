    ...
    <div class="container px-5 py-2 mx-auto lg:pt-24 lg:px-32">
      <div class="flex flex-wrap -m-1 md:-m-2">
        ...
        <div class="flex flex-wrap w-1/2">
          <div class="w-full p-1 md:p-2">
            <img alt="gallery" class="block object-cover object-center w-full h-full"
              src="/images/THIRSTY-11-spritz_cards.jpeg">
          </div>
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20 mb-16">
        <ol class="border-l-2 border-purple-600 w-3/4 m-auto">
          ...
          <li>
            ...
            <div class="ml-6 mb-6 pb-6">
              <p class="text-gray-700 mt-2 mb-4">This is an opportunity for folks to join our community, and build a digital and IRL cellar that celebrates top winemakers dedicated to Earth. All physical bottles will feature a bespoke wine label by inspiring femmes & BIPOC2+ artists. Each drop also grants membership access to VIP experiences at partner restaurant and winery locations that source or farm organic, at minimum.</p>
            </div>
          </li>
          <li>
            <div class="flex flex-start items-center">
