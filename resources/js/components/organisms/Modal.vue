...
import IconEmoji from '../atoms/IconEmoji'
import { useModalStore } from '../../stores/modal';

const { isOpen, title, body, emoji, color } = storeToRefs(useModalStore());
